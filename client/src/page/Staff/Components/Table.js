    ...
    return (
        <>
            ...
            >
                ...
                <TableCell align="center">{row.cv_tgthuchien}</TableCell>
                <TableCell align="center">{row.CV_HANHOANTHANH}</TableCell>
                <TableCell align="center">{row.cv_thgianhoanthanh}</TableCell>
                <TableCell align="center">
                    {row.protein === "Chưa hoàn thành" ? (
                        <span className="text-gray-700">{row.cv_trangthai}</span>
                    ) : (
                        <span className="text-red-500">{row.cv_trangthai}</span>
                    )}
                </TableCell>
                <TableCell align="center">{row.cv_tiendo}</TableCell>
            </TableRow>
            <TableRow>
